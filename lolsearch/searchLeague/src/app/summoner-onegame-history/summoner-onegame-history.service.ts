...
export class SummonerOnegameHistoryService {
  ...
  {
    //this.apiurl = "/api/lol/match/v4/matches/" + gameid + "?api_key=RGAPI-fe1978b0-d25f-4c81-8350-22b474ecd074";//localhost
	  this.apiurl = 'https://cors-anywhere.herokuapp.com/' + this.baseApiUrl + "/lol/match/v4/matches/" + gameid + "?api_key=RGAPI-fe1978b0-d25f-4c81-8350-22b474ecd074";
  }
