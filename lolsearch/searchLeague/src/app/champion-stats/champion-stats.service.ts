...
export class ChampionStatsService {
  ...
  setURL1(name: string){
   ...
   setURL2(name: string){
    this.apiurl = '/api/lol/match/v3/matchlists/by-account/' + name + '?api_key=RGAPI-09a853aa-2d79-4ac0-a027-c4d691a2c504';
  }
   ...
   {
     this.apiurl = '/api/lol/league/v3/challengerleagues/by-queue/RANKED_SOLO_5x5?api_key=RGAPI-09a853aa-2d79-4ac0-a027-c4d691a2c504';
     return this.http.get<TopTwoTier>(this.apiurl, httpOptions).pipe(map(res => res));
   }
    
   getMaster(): Observable<TopTwoTier>
   {
     this.apiurl = '/api/lol/league/v3/masterleagues/by-queue/RANKED_SOLO_5x5?api_key=RGAPI-09a853aa-2d79-4ac0-a027-c4d691a2c504';
     return this.http.get<TopTwoTier>(this.apiurl, httpOptions).pipe(map(res => res));
   }
}
