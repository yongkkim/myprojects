...
export class SummonerHistoryService {
  ...
  setURL(id: string){
   //this.apiurl = '/api/lol/match/v4/matchlists/by-account/' + id + '?beginIndex=0&endIndex=10&api_key=RGAPI-7c87b8f6-ba5c-4821-813a-a1d55d5d201f';
   this.apiurl = 'https://cors-anywhere.herokuapp.com/' + this.baseApiUrl + '/lol/match/v4/matchlists/by-account/' + id + '?beginIndex=0&endIndex=20&api_key=RGAPI-7c87b8f6-ba5c-4821-813a-a1d55d5d201f';
  }
