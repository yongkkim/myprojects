...
export class SummonerHistoryService {
  ...
  setURL(id: string) {
    // this.apiurl = '/api/lol/match/v4/matchlists/by-account/' + id + '?beginIndex=0&endIndex=10&api_key=RGAPI-377c011e-225c-429a-b58c-20e608852524';
    this.apiurl =
      "https://cors-anywhere.herokuapp.com/" +
      this.baseApiUrl +
      "/lol/match/v4/matchlists/by-account/" +
      id +
      "?beginIndex=0&endIndex=20&api_key=RGAPI-377c011e-225c-429a-b58c-20e608852524";
  }
  ...
  getimage(): Observable<Champ> {
    this.apiurl =
      "https://cors-anywhere.herokuapp.com/" +
      this.baseDragonUrl +
      "/cdn/9.13.1/data/en_US/champion.json"; //for production
  ...
  getspell(): Observable<Spell> {
    this.apiurl =
      "https://cors-anywhere.herokuapp.com/" +
      this.baseDragonUrl +
      "/cdn/9.13.1/data/en_US/summoner.json"; //for production
  ...
  getitem(): Observable<Item> {
    this.apiurl =
      "https://cors-anywhere.herokuapp.com/" +
      this.baseDragonUrl +
      "/cdn/9.13.1/data/en_US/item.json"; //for production
