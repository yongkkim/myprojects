...
export class SummonerService {
  ...
  setURL(name: string) {
    ...
    this.apiurl = "baseApiUrl/lol/summoner/v4/summoners/by-name/" + name + "?api_key=RGAPI-b52d3728-fadb-44fe-9d74-d05c55114eff";
  ...
  setURL2(summonerID: string) {
    this.apiurl = "baseApiUrl/lol/league/v4/entries/by-summoner/" + summonerID + "?api_key=RGAPI-b52d3728-fadb-44fe-9d74-d05c55114eff";
