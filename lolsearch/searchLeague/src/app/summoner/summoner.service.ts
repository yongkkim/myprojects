...
export class SummonerService {
  ...
  setURL(name: string){
    this.apiurl = 'https://cors-anywhere.herokuapp.com/' + this.baseApiUrl + '/lol/summoner/v4/summoners/by-name/' + name + '?api_key=RGAPI-c9492ea1-feef-4a79-a1dd-dd1aa5966164';
  ...
  setURL2(summonerID: string){
    this.apiurl = 'https://cors-anywhere.herokuapp.com/' + this.baseApiUrl + '/lol/league/v4/positions/by-summoner/' + summonerID + '?api_key=RGAPI-c9492ea1-feef-4a79-a1dd-dd1aa5966164';
