...
<html lang="en">
  <head>
    ...
    <title>Advidual Media : Service</title>
...
<body onload = "login()">
  ...
  <section id="imgbanner">  
    <h2>Our <font color = "red">Services</font></h2>     
  </section>
  <!-- End banner area -->
      ...
      <div class="row">
         ...
         <!-- start page left side -->
          ...
          <div class="client_title2">
            <hr>
            <h2>Add <span><font>Outdoor Marketing</font></span></h2><br/>
          </div>
		  ...
		  <img src = "img/service2.png"/>
			  ...
			  <p>Why not add outdoor marketing in your marketing strategy with Advidual?</p>
			  <p>We will secure new local customers for your business.</p><br/><br/>
          <div class="client_title2">
            <hr>
            <h2>What <span><font>we provide</font></span></h2><br/>
          </div>
          <div class = "service_pic">
		  <img src = "img/service1.png"/>
		  </div>
			  <p>Advidual’s digital displays play 10 or 15 advertisements for 16 or 24 hours per day depending on its locations and regulations. The 16 or 24 hours of daily playing time is divided into two or three of 8-hour slots, and 5 advertisements will be played in each slot. With a single purchase of our advertising slot, your advertising poster or video will be exposed to local pedestrians by one of our advertising displays either during the daytime (7AM to 3 PM) or nighttime (3 PM to 11 PM) slot.</p>
			  <p>Thus, your advertisement will have 20 seconds of 288 daily plays with 80 seconds of the rotation period. The total play time for 28 days will be 44 hours and 40 minutes.</p><br/><br/>
		  <div class="client_title2">
            <hr>
            <h2>Our <font>Pricing</font></h2><br/>
          </div>    
			  ...
			  <p>On the other hand, there also will be a ‘Buy Now’ option for the customers who want to waive the risk of bid failure. The ‘Buy Now’ option will be priced as our regular price schedule of $5 / hour with 4-week contract ($1,120 for 4 weeks), $4.5 / hour with 8-week contact ($1008 for 4 weeks), $4 / hour with 12-week contract ($896 for 4 weeks). However, we will charge 50% of the regular ‘Buy Now’ price for the first 12 weeks of our service as our opening promotional price.</p>
			  <div class="client_title2">
