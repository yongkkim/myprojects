      ...
      <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-12">
         ...
         <div class="post_navigation">
           <a class="previous_nav wow fadeInLeft" href="#"><i class="fa fa-hand-o-left"></i>Previous Post</a>
           <a class="next_nav wow fadeInRight" href="#">Next Post <i class="fa fa-hand-o-right"></i></a>
         </div>
          <!-- End pagination -->
